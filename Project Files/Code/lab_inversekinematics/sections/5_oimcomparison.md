:::::: collapse Optimization-based Inverse Method (OIM)
...
#runsofa-button("assets/labs/lab_inversekinematics/oim_inversekinematics.py" "--legsName" "blueleg" "--legsModel" "exo2model" "--legsPositionOnMotor" "counterclockwisedown" "clockwisedown" "counterclockwisedown" "clockwisedown" "--centerPartName" "bluepart")
...
#runsofa-button("assets/labs/lab_inversekinematics/oim_inversekinematics.py" "--legsName" "whiteleg" "--legsModel" "exo4model" "--legsPositionOnMotor" "counterclockwisedown" "clockwisedown" "counterclockwisedown" "clockwisedown" "--centerPartName" "bluepart")
